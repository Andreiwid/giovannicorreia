...
#input file
urls = pd.read_csv(r'C:\Users\Administrator\Desktop\dataportals_identified.csv', delimiter='|', encoding='latin-1')
...
for x, row_url in urls.iterrows():
    ...
    #DKAN ==================================================================================================================
    if row_url['PRODUCT'] == 'DKAN':
        try:
            url = row_url['URL'] + '/search'
            ...
            print(str(row_url['ID']) + ' ' + url + ' CONNECTION ISSUE\n')
            file_errors.write(str(datetime.datetime.now()) + '|' + str(row_url['DEPTH']) + '|' + str(row_url['ID']) + '|' +  str(row_url['URL']) + '|' + str(row_url['DOMAIN']) + '|DKAN|' + str(e) + '\n')
            ...
            try:
                ...
                resultado = soup.find("div", class_="view-header")
                ...
                print(str(row_url['ID']) + ' ' + url + ' ' + (str(resultado.text)) + '\n')
                file_results.write(str(datetime.datetime.now()) + '|' + str(row_url['DEPTH']) + '|' + str(row_url['ID']) + '|' +  str(row_url['URL']) + '|' + str(row_url['DOMAIN']) + '|DKAN|' + str(resultado.text) + '|' + domain_country + '|' + ip_country + '|' + root_domain +'\n')

    #PMYDATA ==================================================================================================================
    if row_url['PRODUCT'] == 'PMYDATA':
        try:
            url = row_url['URL'] + '/data'
            ...
            print(str(row_url['ID']) + ' ' + url + ' CONNECTION ISSUE\n')
            file_errors.write(str(datetime.datetime.now()) + '|' + str(row_url['DEPTH']) + '|' + str(row_url['ID']) + '|' +  str(row_url['URL']) + '|' + str(row_url['DOMAIN']) + '|PMYDATA|' + str(e) + '\n')
            ...
            try:
                page = requests.get(url)
                soup = BeautifulSoup(page.content, 'html.parser')
                resultado = soup.find("div", class_="divider")
                children = resultado.find("h5")
                ...
                print(str(row_url['ID']) + ' ' + url + ' ' + str(children.text) + '\n')
                file_results.write(str(datetime.datetime.now()) + '|' + str(row_url['DEPTH']) + '|' + str(row_url['ID']) + '|' +  str(row_url['URL']) + '|' + str(row_url['DOMAIN']) + '|PMYDATA|' + str(children.text) + '|' + domain_country + '|' + ip_country + '|' + root_domain +'\n')
        
    
    #UDATA ==================================================================================================================
    if row_url['PRODUCT'] == 'UDATA':
        try:
            url = row_url['URL'] + '/api/1/datasets/?page_size=1'
            ...
            print(str(row_url['ID']) + ' ' + url + ' CONNECTION ISSUE\n')
            file_errors.write(str(datetime.datetime.now()) + '|' + str(row_url['DEPTH']) + '|' + str(row_url['ID']) + '|' +  str(row_url['URL']) + '|' + str(row_url['DOMAIN']) + '|UDATA|' + str(e) + '\n')

        else:
            #parse JSON
            try:
                response_dict = json.loads(resp.read())
                UDATA_datasetcount = int(response_dict['total'])
                ...
                print(str(row_url['ID']) + ' ' + url + ' ' + str(UDATA_datasetcount) + '\n')
                file_results.write(str(datetime.datetime.now()) + '|' + str(row_url['DEPTH']) + '|' + str(row_url['ID']) + '|' +  str(row_url['URL']) + '|' + str(row_url['DOMAIN']) + '|UDATA|' + str(UDATA_datasetcount) + '|' + domain_country + '|' + ip_country + '|' + root_domain +'\n')

    #JUNAR ==================================================================================================================
    if row_url['PRODUCT'] == 'JUNAR':
        try:
            url = row_url['URL'] + '/manageDeveloper/create/'
            ...
            print(str(row_url['ID']) + ' ' + url + ' CONNECTION ISSUE\n')
            file_errors.write(str(datetime.datetime.now()) + '|' + str(row_url['DEPTH']) + '|' + str(row_url['ID']) + '|' +  str(row_url['URL']) + '|' + str(row_url['DOMAIN']) + '|JUNAR|' + str(e) + '\n')

        else:
            #parse JSON
            try:
                response_dict = json.loads(resp.read())
                JUNAR_KEY = response_dict['pApiKey']
                ...
                #parse JSON
                try:
                    url2 = row_url['DOMAIN'] + '/api/v2/datasets/?auth_key=' + JUNAR_KEY + '&limit=1&format=json'
                    ...
                    try:
                        response_dict2 = json.loads(resp2.read())
                        JUNAR_datasetcount = int(response_dict2['count'])

                    except (ValueError, TypeError, KeyError) as e:
                        print(str(row_url['ID']) + ' ' + url + ' PRODUCT:ERROR/UNKNOWN\n')
                        file_errors.write(str(datetime.datetime.now()) + '|' + str(row_url['DEPTH']) + '|' + str(row_url['ID']) + '|' +  str(row_url['URL']) + '|' + str(row_url['DOMAIN']) + '|JUNAR|' + str(e) + '\n')
                    else:
                        print(str(row_url['ID']) + ' ' + url + ' ' + str(JUNAR_datasetcount) + '\n')
